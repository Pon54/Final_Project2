    ...
    <div class="modal-content">
      <div class="modal-body text-center" style="padding: 40px 20px;">
        ...
        <div style="display: flex; justify-content: center; gap: 15px;">
          ...
          <a href="{{ route('admin.logout') }}" class="btn btn-danger" style="padding: 12px 40px; font-size: 16px; font-weight: 500; border-radius: 4px; background-color: #e74c3c; border: none;">
            Logout
          </a>
        </div>
      </div>
